    ...
    <section
        ...
        <div
            ...
            <div
                ...
                <h2 class="text-xl font-semibold xl:text-4xl text-black-400">Creat New Password</h2><br>
                @if (session('success'))
                ...
                @endif
                <form action="{{route('frontuser.password.update')}}" class="block mt-4 text-start lg:mt-9 md:mt-5">
                    ...
                    <button class="font-semibold text-light-brown md:text-[22px] text-lg bg-dark-blue rounded px-6 md:py-4 py-3.5 w-full md:mt-7 mt-5 md:mb-8 mb-5 hover:bg-transparent hover:border hover:border-dark-blue hover:text-dark-blue transition">Reset Password</button>
                </form>
