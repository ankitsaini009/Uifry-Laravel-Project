    ...
    <section
        ...
        <div
            ...
            <div
                ...
                <form action="{{route('loginuser')}}" class="block mt-4 text-start lg:mt-9 md:mt-5">
                    ...
                    <p class="text-base text-[#505673]">
                        ...
                        <a href="{{route('frontuser.password.request')}}" class="text-dark-blue font-semibold hover:underline">Reset Password</a>.
                    </p>
