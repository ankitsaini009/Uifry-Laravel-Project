    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-12 max-w-[1064px] mx-auto lg:gap-10 gap-y-12 ">
            <div class="md:col-span-7 col-span-12">
                ...
                <a href="{{route('view.bookapintment')}}" class="bg-[#1376F8] hover:bg-[#E6F6FE] duration-700 text-white hover:text-[#011632] lg:font-semibold text-base rounded-[10px] inline-block lg:mt-7 mt-5 lg:py-3.5 py-3 lg:px-[30px] px-5">Book an appoinment</a>
                @else
                <a href="{{ route('front.login') }}" class="bg-[#1376F8] hover:bg-[#E6F6FE] duration-700 text-white hover:text-[#011632] lg:font-semibold text-base rounded-[10px] inline-block lg:mt-7 mt-5 lg:py-3.5 py-3 lg:px-[30px] px-5">Book an appoinment</a>
                @endif
