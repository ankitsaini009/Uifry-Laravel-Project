      ...
      <div>
        <div class="grid grid-cols-12 lg:px-[103px] lg:items-center md:gap-7">
          <div class="lg:col-span-4 md:col-span-4 col-span-12">
            <img class="rounded-t-lg md:rounded-b-lg w-full md:h-auto h-[370px]"
              src="{{ asset('images/' . $specialist['profile_photo']) }}"
              width="304" height="348"
              alt="{{ $specialist['name'] }}">
          </div>
          <div class="lg:col-span-8 md:col-span-8 col-span-12 md:px-0 px-5 md:pt-0 pt-8 lg:pb-0 pb-5 md:bg-white bg-[#E6F6FE] lg:rounded-b-none rounded-b-lg">
        ...
        <div class="swiper-slide">
          <div class="text-center bg-white lg:px-8 px-5 py-5 rounded-xl h-full">
            ...
            <a href="{{ route('view.contact') }}"
              class="underline underline-offset-2 lg:mt-4 mt-3 text-[#011632] text-base font-medium inline-block">Book an appointment<i
