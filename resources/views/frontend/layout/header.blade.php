        ...
        <div class="container">
            <div class="md:bg-[#FFFFFF] rounded-[10px] lg:px-10 md:px-6 px-0 py-5 mx-auto flex items-center justify-between">
                <div class="logo">
                    ...
                    <a href="{{route('front.index')}}"><img src="{{asset('front_assets/public/images/uifry-logo.svg')}}" alt="Logo" width="113" height="35"></a>
                    @else
                    <a href="{{route('front.index')}}"> <img src="{{ asset('images/' . $settings->site_logo) }}" alt="Logo" width="113" height="35"></a>
                    @endif </a>

                </div>
                <ul class="text-base text-[#011632] gap-10 lg:flex hidden pl-[72px]">
                    <li class="font-medium"><a href="{{route('front.index')}}">Home</a></li>
                    <li class="font-medium"><a href="{{route('view.services')}}">Services</a></li>
                    <li class="font-medium"><a href="{{route('view.blogs')}}">Blogs</a></li>
                    <li class="font-medium"><a href="{{route('view.about')}}">About</a></li>
                ...
                <div class="flex items-center lg:gap-5 gap-2.5">
                    <div class="relative z-10">
                        <button onclick="profileMenu()">
                            ...
                            @php $user = auth()->guard('front_user')->user(); @endphp
                            <img src="{{ asset('images/'.$user->image ) }}" width="48" height="48" alt="uifry-profile-icon">
                            @else
                            <!-- <img src="{{ asset('images/1727852246.webp') }}" width="48" height="48" alt="uifry-profile-icon"> -->
                            @endif
                        </button>
                        <ul id="profile-menu" class="min-w-52 absolute -z-10 top-0 right-0 transform hidden translate-y-20 bg-[#FFFFFF] shadow-xl rounded-lg">
                            ...
                            <li class="flex gap-3 border-b border-b-[#e5e7eb] py-3 px-3">
                                <div>
                                    <img src="{{ asset('images/'.$user->image ) }}" width="40" height="40" alt="User Profile">
                                </div>
                                <div>
                                    <span class="text-base font-semibold block">{{ $user->name }}</span>
                            ...
                            <!-- <li class="flex gap-3 border-b border-b-[#e5e7eb] py-3 px-3">
                                <div>
                                    <img src="{{ asset('images/1727852246.webp') }}" width="40" height="40" alt="Guest Profile">
                                </div>
                                <div>
                            ...
                            @if(auth()->guard('front_user')->check())
                            <li class="px-3 py-2.5 border-b border-b-[#e5e7eb]"><a href="{{route('frontuserprofile')}}">My Profile</a></li>
                            <li class="px-3 py-2.5 border-b border-b-[#e5e7eb]"><a href="{{route('userlogout')}}" class="text-red-600">Log Out</a></li>
                            @else
                            @endif
                        </ul>
                    </div>
                    ...
                    <div class="bg-[#1376F8] hover:bg-[#011632] duration-700 font-semibold text-base rounded-[10px] md:flex hidden lg:py-3.5 py-2.5 lg:px-[30px] md:px-4 px-2.5 cursor-pointer">
                        <a href="{{route('view.bookapintment')}}" class="text-white">Book Now</a>
                    </div>
                    @else
                    ...
                    <div class="bg-[#FFFFFF] text-black !text-black font-semibold text-base rounded-[10px] md:flex hidden lg:py-3.5 py-2.5 lg:px-[30px] md:px-4 px-2.5 cursor-pointer">
                        <a href="{{ route('front.login') }}" class="text-black">Login</a>
                    </div>

                    <!-- "Sign Up" Button (Only for Guests) -->
                    <div class="bg-[#1376F8] hover:bg-[#011632] duration-700 font-semibold text-base rounded-[10px] md:flex hidden lg:py-3.5 py-2.5 lg:px-[30px] md:px-4 px-2.5 cursor-pointer">
                        <a href="{{ route('front.registration') }}" class="text-white">Sign Up</a>
                    </div>
                    @endif
                ...
                <div id="mobile-menu"
                    ...
                    <ul class="flex flex-col font-medium text-black py-5 px-3 gap-5">
                        <li class="font-semibold hover:font-bold"><a href="{{route('front.index')}}">Home</a></li>
                        <li class="font-semibold hover:font-bold"><a href="{{route('view.services')}}">Services</a></li>
                        <li class="font-semibold hover:font-bold"><a href="{{route('view.blogs')}}">Blogs</a></li>
                        <li class="font-semibold hover:font-bold"><a href="{{route('view.about')}}">About</a></li>
                        <li class="font-semibold hover:font-bold"><a href="{{ route('view.contact') }}">Contact</a></li>
                    </ul>
                    @if(Auth::guard('front_user')->check())
                    <a href="{{route('view.bookapintment')}}" class="md:hidden bg-[#1376F8] text-white hover:bg-[#011632] duration-700 font-semibold text-base rounded-[10px] inline-block text-center lg:py-3.5 py-2.5 px-[30px] cursor-pointer" style="margin-left:12px;">Book Now</a>
                    @else

                    <!-- "Sign Up" Button (Only for Guests) -->
                    <a href="{{ route('front.registration') }}" class="text-black font-semibold block md:hidden" style="margin-left:12px;">Sign Up</a>

                    <!-- "Login" Button (Only for Guests) -->
                    <a href="{{ route('front.login') }}" class="text-black mt-5 md:hidden inline-block bg-[#1376F8] text-white duration-700 font-semibold text-base rounded-[10px] py-3.5 px-[30px] cursor-pointer" style="margin-left:12px;">Login</a>
                    @endif
                </div>
            </div>
        </div>
