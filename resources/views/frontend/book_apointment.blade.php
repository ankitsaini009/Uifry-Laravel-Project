                    ...
                    <div id="step1">
                        ...
                        <div class="mt-10">
                            ...
                            <div class="rounded-lg flex items-center gap-2 bg-[#FFFFFF] w-full mx-auto border border-[#D0D5DD] p-4 mt-2.5">
                                ...
                                <input type="text" autocomplete="off" id="first_name" name="first_name" class="text-base outline-none w-full" placeholder="First Name" required>
                            </div>
                        </div>
                        ...
                        <div class="lg:mt-6 mt-4">
                            ...
                            <div class="rounded-lg flex items-center gap-2 bg-[#FFFFFF] w-full mx-auto border border-[#D0D5DD] p-4 mt-2.5">
                                <i class="fa-regular fa-envelope text-2xl text-[#AFAFAF]"></i>
                                <input type="text" autocomplete="off" name="email" id="email" class="text-base outline-none w-full" placeholder="Email" required>
                            </div>
                        </div>
                        ...
                        <div class="lg:mt-6 mt-4">
                            ...
                            <div class="rounded-lg flex items-center gap-2 bg-[#FFFFFF] w-full mx-auto border border-[#D0D5DD] p-4 mt-2.5">
                                <i class="fa-solid fa-lock text-2xl text-[#AFAFAF]"></i>
                                <input id="phone" type="number" autocomplete="off" name="phone" class="text-base outline-none w-full" placeholder="Phone No." required>
                            </div>
                        </div>
