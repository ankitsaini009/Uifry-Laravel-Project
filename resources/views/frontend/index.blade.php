    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-12 lg:mt-[60px] mt-10">
            <div class="lg:col-span-7 md:col-span-6 col-span-12 lg:pt-10 lg:pb-10 pb-12">
                <h1 class="lg:text-[62px] text-[40px] z-10 font-semibold text-[#011632] tracking-[-2px] relative">{{$PagesContantManage['hero_section']['banner_title']}}
                ...
                <div class="md:max-w-[374px] shadow-2xl bg-[#FFFFFF] px-4 py-3 rounded-2xl mt-12">
                    <div class="flex justify-between items-start">
                        ...
                        <a target="_blank" href="{{$PagesContantManage['hero_section']['linkedin']['profile_link']}}"><img class="mt-0.5" src="{{asset('front_assets/public/images/uifry-linkedin.svg')}}" width="25" height="25" alt="uifry-linkedin"></a>
                    </div>
    ...
    <div class="container">
        <div class="grid grid-cols-12 lg:items-end items-center lg:gap-0 md:gap-5 gap-y-12 lg:px-10 px-0">
            <div class="md:col-span-6 col-span-12 lg:max-w-[530px]">
                <h2 class="text-[#011632] lg:text-[42px] text-3xl font-semibold inline-block">{{$PagesContantManage['home_section']['email_subscribe']['title']}}</h2>
                <p class="text-[#3C4959] text-lg lg:mt-5 mt-3">{{$PagesContantManage['home_section']['email_subscribe']['description']}}</p>
                <div
            ...
            <div class="md:col-span-6 col-span-12 text-right">
                <img class="relative rounded-lg" src="{{ asset('uploads/' . $PagesContantManage['home_section']['email_subscribe']['image']) }}" width="413" height="362"
    ...
    <div class="container">
        <div class="grid grid-cols-12 lg:gap-0 md:gap-5 gap-y-12 lg:items-start items-center lg:px-10 px-0">
            ...
            <div class="md:col-span-6 col-span-12 text-right lg:pe-7">
                <img class="relative rounded-lg" src="{{ asset('uploads/' . $PagesContantManage['home_section']['smile_image']) }}" width="410" height="326"
                    alt="uifry-healthier">
...
<section class="patients lg:pb-[120px] pb-[70px]">
    <div class="container mx-auto lg:!max-w-[1064px] md:text-center">
        ...
        <div class="mt-12 relative">
            ...
            <iframe class="rounded-xl w-full lg:inline hidden" width="560" height="350" src="{{ old('about_patients_overview_video', isset($PagesContantManage) ? $PagesContantManage['home_section']['video']['url'] : '') }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    ...
    <div class="container mx-auto lg:pb-[100px]">
        <div class="grid grid-cols-12 max-w-[1064px] mx-auto bg-[#011632] rounded-xl lg:px-[52px] py-12 md:gap-2.5 gap-y-10">
            <div class="md:col-span-8 col-span-12 md:pt-3">
                <h2 class="lg:text-[42px] text-3xl text-[#FFFFFF] font-semibold"><span class="lg:inline hidden">{{$PagesContantManage['home_section']['footer']['title']}}</h2>
