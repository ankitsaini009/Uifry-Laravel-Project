                ...
                <div class="swiper-wrapper flex transition-transform duration-300 ">
                    ...
                    <div class="swiper-slide rounded-lg overflow-hidden relative">
                        ...
                        <div class="absolute top-0 left-0 w-full h-full p-4 flex flex-col justify-between items-end">
                            <a href="{{$specialist->linkdin_profile_link}}"><i class="fa-brands fa-linkedin text-black text-4xl"></i></a>
...
<section class="comments lg:pb-[150px] pb-[70px]">
    <div class="container">
            ...
            <div class="flex items-start gap-2.5 mt-7">
                ...
                <div class="w-full">
                    <div class="lg:flex items-center justify-between">
                        <h3 class="text-[#011632] lg:text-2xl text-xl font-semibold mt-1">
                            {{ $comment->name }} ({{ $comment->created_at->format('M d, Y') }})
                        </h3>
                    </div>
                    <p class="text-base text-[#011632] mt-2 text-justify">{{ $comment->description }}</p>
                </div>
            </div>
            @endforeach
        </div>
        ...
        <div class="bg-[#E6F6FE] border border-[#DDDDDD] p-5 rounded-lg">
            <h2 class="lg:text-[42px] text-4xl text-[#011632] font-semibold">Leave A Reply</h2>
            @if(session('success'))
