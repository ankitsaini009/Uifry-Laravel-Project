    ...
    <div class="container mx-auto">
        ...
        <!-- <form action="">
            <div class="rounded-lg flex items-center gap-2 lg:mt-10 mt-5 lg:h-14 h-12 bg-[#FFFFFF] border border-[#CFCFCF] lg:py-3.5 py-3 px-3">
                <span class="">
                    <img class="max-w-max" src="{{asset('front_assets/public/images/uifry-call-icon.svg')}}" width="25" height="25" alt="call-icon">
                </span>
                <input type="text" class="lg:text-base text-sm outline-none w-full" placeholder="Search" id="leadingIconDefault">
            </div>
        </form> -->
...
<section class="articles lg:py-12 py-[70px]">
    <div class="container mx-auto">
        ...
        <!-- Manual Pagination -->
        <div class="lg:flex hidden justify-center gap-5 text-xl mt-12">
            <!-- Previous Button -->
            @if($page > 1)
        ...
        <div class="lg:hidden flex justify-center gap-2.5 lg:mt-10 mt-5">
            <div
                class="article-button-prev group z-10 bg-[#011632] hover:bg-[#E6F6FE] duration-700 static lg:py-2.5 py-2 lg:px-8 px-5 cursor-pointer">
                <img class="hidden group-hover:inline" src="{{asset('front_assets/public/images/uifry-arrow.webp')}}" width="42" height="13" alt="uifry-arrow">
                <img class="group-hover:hidden" src="{{asset('front_assets/public/images/uifry-light-arrow.webp')}}" width="42" height="13" alt="uifry-arrow">
            </div>
            <div
                class="article-button-next group z-10 bg-[#011632] hover:bg-[#E6F6FE] duration-700 static lg:py-2.5 py-2 lg:px-8 px-5 cursor-pointer">
