...
class ComentsController extends Controller
{
    ...
    public function comentstore(Request $request)
    {
        ...
        if (isset($request->Blogcoment_id) && !empty($request->Blogcoment_id)) {
            ...
            $Blogcoment->services_id = $request->services_id;
    ...
    public function comentcreate()
    {
        ...
        $Blogs = Blog::all();
        $Users = User::all();
        return view('admin.coments.add', compact('Users', 'Blogs', 'services'));
    }
    ...
    public function comentedit($id)
    {
        ...
        return view('admin.coments.add', compact('Blogcoment', 'Users', 'Blogs', 'services'));
    }
