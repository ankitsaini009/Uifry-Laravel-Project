...
<section class="login">
    <div class="grid grid-cols-12 overflow-hidden items-center">
        <div class="col-span-6 relative lg:block hidden">
            <img class="w-full rounded-tr-[10px]" src="<?php echo e(asset('front_assets/public/images/uifry-login.webp')); ?>" width=" 674" height="817" alt="uifry-login">
        ...
        <div class="lg:col-span-6 col-span-12 lg:pl-[128px] lg:px-0 px-6 py-[70px]">
            <div class="max-w-[414px] lg:mx-0 mx-auto">
                ...
                <a href="<?php echo e(route('auth.google')); ?>" class="bg-[#FFFFFF] w-full flex items-center justify-center gap-3 lg:py-5 py-4 lg:mt-9 mt-6 lg:border border-[#011632] rounded-lg text-[#011632] lg:bg-transparent">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('loginuser')); ?>">
                    ...
                    <div class="text-danger" style="color: red;"><?php echo e($errors->first('password')); ?></div>
                    <?php endif; ?>
                    <div class="flex items-center justify-between text-sm text-[#011632] lg:mt-5 mt-4">
                        ...
                        <a href="<?php echo e(route('frontuser.password.request')); ?>" class="underline">Forgot Password?</a>
                    </div>
                ...
                <p class="mt-5 text-center text-[#011632]">Not member yet? <a href="<?php echo e(route('front.registration')); ?>" class="font-semibold hover:underline">Create an account</a></p>
            </div>
        </div>
    </div>
</section>
...
</body><?php /**PATH E:\xampp\htdocs\laravel-uifry\resources\views/frontend/user_login/login.blade.php ENDPATH**/ ?>