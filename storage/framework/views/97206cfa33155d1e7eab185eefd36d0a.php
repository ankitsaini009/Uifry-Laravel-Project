...
<footer class="lg:pt-0 pt-12">
    <div class="container mx-auto">
        <div class="flex justify-between items-center md:border-b-2 md:border-b-[#011632] lg:pb-12 md:pb-7">
            ...
            <a href=""><img src="<?php echo e(asset('front_assets/public/images/uifry-logo.svg')); ?>" alt="Logo" width="113" height="35"></a>
            <?php else: ?>
            <a href=""> <img src="<?php echo e(asset('images/' . $settings->site_logo)); ?>" alt="Logo" width="113" height="35"></a>
            <?php endif; ?> </a>
            ...
            <div class="relative md:hidden">
                ...
                <ul id="footer-menu" class="hidden absolute bottom-0 right-[110%] text-base font-medium bg-[#011632] text-white p-3 rounded-lg">
                    ...
                    <li class="pb-1"><a href="service.html">Service</a></li>
                    <li class="pb-1"><a href="blog.html">Blogs</a></li>
                    <li class="pb-1"><a href="about.html">About</a></li>
                    <li class="pb-1"><a href="contact.html">Contact</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="lg:py-[30px] md:py-5 md:flex md:flex-row flex-col justify-between items-center">
            ...
            <p class="text-[#011632] text-sm md:block hidden">All rights reserved ® <a href="index.html">uifry.com</a> | Terms and
                conditions apply!</p>
            <div class="inline-flex lg:gap-5 gap-2.5 md:border-t-transparent border-t border-t-[#AEAEAE] md:pt-0 pt-2.5 md:mt-0 mt-2.5">
                <a href="#"><i class="fa-brands fa-facebook md:bg-[#011632] bg-[#666666] text-white p-2 rounded-full"></i></a>
                <a href="#"><i class="fa-brands fa-instagram md:bg-[#011632] bg-[#666666] text-white p-2 rounded-full"></i></a>
                <a href="#"><i class="fa-brands fa-youtube md:bg-[#011632] bg-[#666666] text-white p-2 rounded-full"></i></a>
                <a href="#"><i class="fa-brands fa-linkedin md:bg-[#011632] bg-[#666666] text-white p-2 rounded-full"></i></a>
                <a href="#"><i class="fa-brands fa-twitter md:bg-[#011632] bg-[#666666] text-white p-2 rounded-full"></i></a>
            </div>
        </div>
    </div>
