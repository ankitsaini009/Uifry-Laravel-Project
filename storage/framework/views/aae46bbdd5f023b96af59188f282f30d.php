    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-12 lg:mt-[60px] mt-10">
                ...
                <div class="md:max-w-[374px] shadow-2xl bg-[#FFFFFF] px-4 py-3 rounded-2xl mt-12">
                    <div class="flex justify-between items-start">
                        <div class="flex gap-2 items-center">
                            <img src="<?php echo e(asset('front_assets/public/images/uifry-thomas-daniel.svg')); ?>" width="45" height="45" alt="Thomas daniel">
                        ...
                        <img class="mt-0.5" src="<?php echo e(asset('front_assets/public/images/uifry-linkedin.svg')); ?>" width="25" height="25" alt="uifry-linkedin">
                    </div>
            ...
            <div class="lg:col-span-5 md:col-span-6 col-span-12 lg:-ms-20 flex items-end">
                <img class="w-full" src="<?php echo e(asset('front_assets/public/images/uifry-hero-section.png')); ?>" width="610" height="660" alt="uifry-hero-section">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="grid grid-cols-12 lg:items-end items-center lg:gap-0 md:gap-5 gap-y-12 lg:px-10 px-0">
            ...
            <div class="md:col-span-6 col-span-12 text-right">
                <img class="relative rounded-lg" src="<?php echo e(asset('front_assets/public/images/uifry-booking-details.webp')); ?>" width="413" height="362"
        ...
        <div class="bg-[#E6F6FE] lg:px-10 px-0 lg:py-12 py-[70px]">
            <div class="grid grid-cols-12 lg:gap-0 md:gap-5 gap-y-12 lg:items-start items-center">
                <div class="md:col-span-6 col-span-12 lg:order-1 order-2">
                    <img class="rounded-xl lg:w-auto w-full" src="<?php echo e(asset('front_assets/public/images/uifry-book-appointment.webp')); ?>" width="414" height="444"
                ...
                <div class="md:col-span-6 col-span-12 lg:order-2 order-1">
                    ...
                    <ul>
                        <li>
                            <img src="<?php echo e(asset('front_assets/public/images/uifry-list-icon.svg')); ?>" width="20" height="20" alt="uifry-list-icon">
    ...
    <div class="container">
        <div class="grid grid-cols-12 lg:gap-0 md:gap-5 gap-y-12 lg:items-start items-center lg:px-10 px-0">
            ...
            <div class="md:col-span-6 col-span-12 text-right lg:pe-7">
                <img class="relative rounded-lg" src="<?php echo e(asset('front_assets/public/images/uifry-healthier.webp')); ?>" width="410" height="326"
                    alt="uifry-healthier">
...
<section class="patients lg:pb-[120px] pb-[70px]">
    <div class="container mx-auto lg:!max-w-[1064px] md:text-center">
        ...
        <div class="mt-12 relative">
            <img class="rounded-xl w-full lg:inline hidden" src="<?php echo e(asset('front_assets/public/images/uifry-patients.webp')); ?>" width="1064" height="452"
                alt="uifry-patients">
            <img class="rounded-xl w-full lg:hidden inline lg:max-h-auto md:max-h-[500px] max-h-[300px] object-cover" src="<?php echo e(asset('front_assets/public/images/uifry-patients-mobile-image.webp')); ?>" width="388"
            ...
            <div
                ...
                <a href="#"><img src="<?php echo e(asset('front_assets/public/images/uifry-play-btn.svg')); ?>" width="52" height="52" alt="play-btn"></a>
            </div>
        </div>
    ...
    <div class="container mx-auto lg:pb-[100px]">
        <div class="grid grid-cols-12 max-w-[1064px] mx-auto bg-[#011632] rounded-xl lg:px-[52px] py-12 md:gap-2.5 gap-y-10">
            ...
            <div class="md:col-span-4 col-span-12">
                <img class="rounded-xl lg:w-auto w-full" src="<?php echo e(asset('front_assets/public/images/uifry-dental-rules.webp')); ?>" width="305" height="292"
                    </div>
            </div>
        </div>
</section>
