    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-12 lg:mt-[60px] mt-10">
            <div class="lg:col-span-7 md:col-span-6 col-span-12 lg:pt-10 lg:pb-10 pb-12">
                <h1 class="lg:text-[62px] text-[40px] z-10 font-semibold text-[#011632] tracking-[-2px] relative"><?php echo e($PagesContantManage['hero_section']['banner_title']); ?>

                    <img class="absolute -z-10 lg:bottom-[1%] bottom-[3%] left-0 lg:w-[90%] w-[49%]"
                        src="<?php echo e(asset('front_assets/public/images/uifry-heading-border.webp')); ?>" alt="heading-border">
                </h1>
                <p class="text-lg lg:max-w-[531px] text-[#3C4959] lg:mt-5 mt-8"><?php echo e($PagesContantManage['hero_section']['description']); ?></p>
                <div class="flex lg:gap-6 gap-2.5 lg:mt-10 mt-8">
                    <?php if(Auth::guard('front_user')->check()): ?>
                    <a href="<?php echo e(route('view.bookapintment')); ?>"
                    ...
                    <div class="flex lg:gap-4 gap-2 items-center">
                        ...
                        <div class="text-sm">
                            ...
                            <a class="font-medium text-[#011632]" href="tel:0900-78601"><?php echo e($PagesContantManage['hero_section']['emergency_number']); ?></a>
                        </div>
                    </div>
                </div>
                <div class="md:max-w-[374px] shadow-2xl bg-[#FFFFFF] px-4 py-3 rounded-2xl mt-12">
                    <div class="flex justify-between items-start">
                        <div class="flex gap-2 items-center">
                            <img src="<?php echo e(asset('uploads/' . $PagesContantManage['hero_section']['linkedin']['profile_image'])); ?>" width="45" height="45" alt="Thomas daniel">
                            <div class="text-[#011632] leading-normal">
                                <span class="text-sm font-medium block"><?php echo e($PagesContantManage['hero_section']['linkedin']['name']); ?></span>
                                <a class="font-medium text-xs" href="tel:0900-78601">Sr Dental</a>
                            </div>
                        </div>
                        <a target="_blank" href="<?php echo e($PagesContantManage['hero_section']['linkedin']['profile_link']); ?>"><i class="mt-0.5 fa-brands fa-linkedin text-[#1376F8] text-3xl"></i></a>
                    </div>
                    <p class="text-xs mt-3"><?php echo e($PagesContantManage['hero_section']['linkedin']['description']); ?></p>
                </div>
            </div>
            <div class="lg:col-span-5 md:col-span-6 col-span-12 lg:-ms-20 flex items-end">
                <img class="w-full" src="<?php echo e(asset('uploads/' . $PagesContantManage['hero_section']['bannerImage'])); ?>" width="610" height="660" alt="uifry-hero-section">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container lg:pt-0 pt-12 lg:pb-0 pb-[30px]">
                ...
                <div class="swiper-slide">
                    <div class="text-center bg-white lg:px-8 px-5 py-5 rounded-xl h-full">
                        <div class="bg-[#25B4F8] rounded-full inline-block p-3">
                            <img src="<?php echo e(asset('images/' . $service->image)); ?>" width="48" height="48" alt="<?php echo e($service->name); ?>">
                        </div>
                        <h3 class="text-[#011632] text-2xl font-medium lg:my-4 my-3"><?php echo e($service->name); ?></h3>
                        <p class="text-[#3C4959] text-lg"><?php echo e(strip_tags($service->description)); ?></p>
                        <a href="<?php echo e(route('view.services.detail',$service->id)); ?>"
        ...
        <div class="lg:hidden flex justify-center lg:gap-5 gap-3 lg:mt-10 mt-5">
            <div class="swiper-button-prev4 group z-10 bg-white static lg:py-2.5 py-2 lg:px-8 px-5 cursor-pointer">
                <img src="<?php echo e(asset('front_assets/public/images/uifry-arrow.webp')); ?>" width="42" height="13" alt="uifry-arrow">
            </div>
            <div class="swiper-button-next4 group z-10 bg-white static lg:py-2.5 py-2 lg:px-8 px-5 cursor-pointer">
                <img class="rotate-180" src="<?php echo e(asset('front_assets/public/images/uifry-arrow.webp')); ?>" width="42" height="13" alt="uifry-arrow">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="grid grid-cols-12 items-center md:gap-5 gap-y-12 lg:px-10 px-0">
            <div class="md:col-span-7 col-span-12">
                <h2 class="text-[#011632] lg:text-[42px] text-4xl font-semibold inline-block"><?php echo e($PagesContantManage['home_section']['email_subscribe']['title']); ?></h2>
                <p class="text-[#3C4959] text-lg lg:mt-5 mt-3 lg:max-w-[530px]"><?php echo e($PagesContantManage['home_section']['email_subscribe']['description']); ?></p>
            ...
            <div class="md:col-span-5 col-span-12 text-right">
                <img class="lg:w-auto w-full" src="<?php echo e(asset('uploads/' . $PagesContantManage['home_section']['email_subscribe']['image'])); ?>" width="413" height="362"
        ...
        <div class="bg-[#E6F6FE] lg:px-10 px-0 lg:py-12 py-[70px]">
            <div class="grid grid-cols-12 lg:gap-0 md:gap-5 gap-y-12 lg:items-start items-center">
                <div class="md:col-span-6 col-span-12 lg:order-1 order-2">
                    <img class="rounded-xl lg:w-auto w-full" src="<?php echo e(asset('uploads/' . $PagesContantManage['home_section']['dental_treatments_image'])); ?>" width="414" height="444"
                        alt="uifry-book-appointment">
                </div>
                <div class="md:col-span-6 col-span-12 lg:order-2 order-1">
                    <div class="md:col-span-6 col-span-12 lg:order-2 order-1">
                        <?php echo $PagesContantManage['home_section']['dental_treatments_content']; ?>
    ...
    <div class="container">
        <div class="grid grid-cols-12 md:gap-5 gap-y-12 items-center lg:px-10 px-0">
            <div class="md:col-span-6 col-span-12">
                <?php echo $PagesContantManage['home_section']['smile_content']; ?>
            ...
            <div class="md:col-span-6 col-span-12 text-right">
                <img class="lg:w-auto w-full" src="<?php echo e(asset('uploads/' . $PagesContantManage['home_section']['smile_image'])); ?>" width="410" height="326"
                    alt="uifry-healthier">
...
<section class="patients lg:pb-[120px] pb-[70px]">
    <div class="container mx-auto lg:!max-w-[1064px] md:text-center">
        <h2
            class="lg:text-[42px] text-4xl text-[#011632] font-semibold inline-block lg:max-w-[630px] md:max-w-[500px]  max-w-[361px] mx-auto"><?php echo e($PagesContantManage['home_section']['video']['title']); ?>

        </h2>
        <p class="text-[#3C4959] text-lg lg:mt-5 mt-3 lg:max-w-[460px] md:max-w-[80%] mx-auto"><?php echo e($PagesContantManage['home_section']['video']['description']); ?></p>
        <div class="mt-12 relative patients-video">

            <iframe class="rounded-xl w-full iframe" width="560" height="350" src="<?php echo e(old('about_patients_overview_video', isset($PagesContantManage) ? $PagesContantManage['home_section']['video']['url'] : '')); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            ...
            <div class="fixed inset-0 transition-opacity w-full top-0 left-0 h-auto hidden z-[99999]" id="video-modal-popup">
                <div class="absolute top-0 left-0 inset-0 bg-[#E6F6FE] bg-opacity-90 overflow-y-scroll" style="scrollbar-width: none;">
                    <div class="text-end p-3 lg:p-5"><i class="fa-regular fa-circle-xmark text-black cursor-pointer text-3xl" onclick="toggleModal()"></i></div>
                    <div class="container h-full w-full flex justify-center items-center">
                        <iframe class="lg:rounded-xl rounded-lg lg:w-[80%] w-full h-[70%]" width="560" height="350" src="<?php echo e(old('about_patients_overview_video', isset($PagesContantManage) ? $PagesContantManage['home_section']['video']['url'] : '')); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
...
<section class="meet-specialists bg-[#E6F6FE] lg:pt-[60px] pt-12 lg:pb-14 pb-12 overflow-hidden">
            ...
            <div class="swiper-container swipe1">
                <div class="swiper-wrapper flex transition-transform duration-300 ">
                    ...
                    <div class="swiper-slide rounded-lg overflow-hidden relative">
                        <img class="w-full" src="<?php echo e(asset('images/' . $specialist->profile_photo)); ?>" width="305" height="340"
                            alt="uifry-specialists-carry">
                        <div class="absolute top-0 left-0 w-full h-full p-4 flex flex-col justify-between items-end">
                            <a href="#"><i class="fa-brands fa-linkedin text-black text-4xl"></i></a>
                            <div class="text-[#FFFFFF] w-full pt-3 pb-5 px-6 rounded-lg"
                                ...
                                <h3 class="text-2xl font-medium"><?php echo e($specialist->name); ?></h3>
                                <p class="text-base font-medium mt-1"><?php echo e($specialist->specialization); ?></p>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="text-center mt-7 lg:hidden block">
        <button type="button"
            class="bg-[#1376F8] text-white lg:font-semibold text-base rounded-[10px] inline-block lg:py-3.5 py-3 lg:px-7.5 px-5">View
            all Members</button>
    </div>
    </div>
    <div class="lg:flex hidden justify-center gap-2.5 mt-10">
        <div
            ...
            <img class="group-hover:hidden" src="<?php echo e(asset('front_assets/public/images/uifry-arrow.webp')); ?>" width="42" height="13" alt="uifry-arrow">
            <img class="hidden group-hover:inline" src="<?php echo e(asset('front_assets/public/images/uifry-light-arrow.webp')); ?>" width="42" height="13"
                alt="uifry-arrow">
        </div>
        <div
            class="swiper-button-next1 group z-10 bg-white hover:bg-[#1376F8] duration-700 static py-2.5 px-8 cursor-pointer">
            <img class="rotate-180 group-hover:hidden" src="<?php echo e(asset('front_assets/public/images/uifry-arrow.webp')); ?>" width="42" height="13"
                alt="uifry-arrow">
            <img class="rotate-180 hidden group-hover:inline" src="<?php echo e(asset('front_assets/public/images/uifry-light-arrow.webp')); ?>" width="42" height="13"
                alt="uifry-arrow">
        </div>
    </div>
</section>
<section class="our-clients bg-[#FFFFFF] lg:pt-[100px] pt-[70px] pb-[100px] overflow-hidden">
                ...
                <div class="swiper-wrapper flex transition-transform duration-300">
                    ...
                    <div class="swiper-slide lg:p-7 p-5">
                        <div class="flex gap-2.5 items-center">
                            <img src="<?php echo e(asset('images/' . $Testimonial->image)); ?>" width="70" height="70" alt="Thomas daniel">
                            <div>
                                <h3 class="text-2xl text-[#011632] font-medium"><?php echo e($Testimonial->name); ?></h3>
                        ...
                        <p class="text-[#3C4959] text-base mt-4"><?php echo e($Testimonial->feedback); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="flex justify-center gap-2.5 lg:mt-10 mt-5">
        <div
            ...
            <img class="hidden group-hover:inline" src="<?php echo e(asset('front_assets/public/images/uifry-arrow.webp')); ?>" width="42" height="13" alt="uifry-arrow">
            <img class="group-hover:hidden" src="<?php echo e(asset('front_assets/public/images/uifry-light-arrow.webp')); ?>" width="42" height="13" alt="uifry-arrow">
        </div>
        <div
            ...
            <img class="rotate-180 hidden group-hover:inline" src="<?php echo e(asset('front_assets/public/images/uifry-arrow.webp')); ?>" width="42" height="13"
                alt="uifry-arrow">
            <img class="rotate-180 group-hover:hidden" src="<?php echo e(asset('front_assets/public/images/uifry-light-arrow.webp')); ?>" width="42" height="13"
                alt="uifry-arrow">
        </div>
    </div>
</section>
        ...
        <div class="swiper-container swipe3 lg:mt-[70px] mt-12">
            <div class="swiper-wrapper transition-transform duration-300 lg:grid lg:grid-cols-12 lg:gap-5">
                ...
                <div class="swiper-slide rounded-xl bg-[#E6F6FE] px-5 pt-5 pb-2.5 lg:col-span-3 md:col-span-4">
                    <img class="rounded-xl w-full lg:h-48 object-cover article-image" src="<?php echo e(asset('images/'.$Blog->image)); ?>" width="265" height="190" alt="uifry-article">
                    <span class="inline-block bg-[#011632] rounded-md text-base text-white px-3 py-1.5 mt-5"><?php echo e(strip_tags($Blog->blog_cat)); ?></span>
                    <a href="" class="text-lg font-medium text-[#011632] lg:mt-[14px] mt-3 block"><?php echo e($Blog->title); ?></a>
                    <p class="text-lg text-[#3C4959] lg:mt-2.5 mt-1"><?php echo e(strip_tags($Blog->description)); ?></p>
                    <span class="text-base text-[#011632] block text-right lg:mt-0.5 mt-2.5"><?php echo e(strip_tags($Blog->auther)); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
<section class="ask-questions lg:pt-[120px] pt-[70px] lg:pb-[120px] pb-[70px]">
    <div class="container mx-auto">
        ...
        <div class="lg:max-w-[625px] md:max-w-[500px] mx-auto lg:mt-14 mt-12">
            ...
            <div class="border-b border-b-[#CFCFCF] accord-item rounded-lg <?php echo e($index == 0 ? 'active' : ''); ?>">
                <button
                    class="accordion-btn relative w-full flex items-center gap-2 justify-between lg:pl-10 pl-8 lg:pr-[20px] pr-4 py-[20px] text-left text-lg text-[#011632] font-medium <?php echo e($index == 0 ? 'active' : ''); ?> before:content-[''] before:absolute md:before:top-[49%] before:top-[35%] md:before:left-[3%] before:left-[5%] before:bg-[#011632] before:rounded-full before:w-1.5 before:h-1.5"
                ...
                <div class="accordion-content lg:px-10 px-4 <?php echo e($index == 0 ? 'active' : ''); ?>"
                    style="<?php echo e($index == 0 ? 'max-height: none; padding-top: 8px; padding-bottom: 8px;' : 'max-height: 0px; padding-top: 0px; padding-bottom: 0px;'); ?>">
                    <p class="text-lg"><?php echo e(strip_tags($Faq->answer)); ?></p>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="container mx-auto lg:pb-[100px]">
        <div class="grid grid-cols-12 lg:items-center max-w-[1064px] mx-auto bg-[#011632] rounded-xl lg:px-[52px] py-12 md:gap-2.5 gap-y-12">
            <div class="md:col-span-8 col-span-12">
                <h2 class="lg:text-[42px] text-4xl text-[#FFFFFF] font-semibold"><?php echo e($PagesContantManage['home_section']['footer']['title']); ?></h2>
                <p class="text-[#FFFFFF] text-lg mt-5 font-normal lg:max-w-[78%]"><?php echo e($PagesContantManage['home_section']['footer']['description']); ?></p>
                <?php if(Auth::guard('front_user')->check()): ?>
                <a href="<?php echo e(route('view.bookapintment')); ?>"
            ...
            <div class="md:col-span-4 col-span-12">
                <img class="rounded-xl lg:w-auto w-full" src="<?php echo e(asset('uploads/' . $PagesContantManage['home_section']['footer']['image'])); ?>" width="305" height="292">
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('frontend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\laravel-uifry\resources\views/frontend/index.blade.php ENDPATH**/ ?>