        ...
        <div class="grid grid-cols-12 lg:gap-5 gap-y-10">
            ...
            <div class="col-span-12 md:col-span-8">
                ...
                <form action="<?php echo e(route('frontuserstore')); ?>" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="grid grid-cols-12 lg:mt-7 mt-5 lg:gap-5 gap-3">
                        <div class="lg:col-span-6 col-span-12">
                            <input id="name" name="name" type="text" placeholder="Enter Name"
                                class="outline-none h-auto bg-[#FFFFFF] text-[#667085] w-full text-sm border border-[#D0D5DD] p-4 rounded-lg shadow-sm" value="<?php echo e(isset($userdata->name)?$userdata->name:''); ?>" required>
                        ...
                        <div class="lg:col-span-6 col-span-12">
                            <input id="email" name="email" type="email" value="<?php echo e(isset($userdata->email)?$userdata->email:''); ?>" placeholder="Enter Email"
                                class="outline-none h-auto bg-[#FFFFFF] text-[#667085] w-full text-sm border border-[#D0D5DD] p-4 rounded-lg shadow-sm" required>
                        ...
                        <div class="lg:col-span-6 col-span-12">
                            <input id="phone" name="phone" type="number" value="<?php echo e(isset($userdata->phone)?$userdata->phone:''); ?>" placeholder="Enter Phone Number"
                                class="outline-none h-auto bg-[#FFFFFF] text-[#667085] w-full text-sm border border-[#D0D5DD] p-4 rounded-lg shadow-sm">
...
<?php echo $__env->make('frontend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\laravel-uifry\resources\views/frontend/profile_edit.blade.php ENDPATH**/ ?>