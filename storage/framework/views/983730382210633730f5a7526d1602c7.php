            ...
            <div class="lg:col-span-7 md:col-span-6 col-span-12 lg:pt-10 lg:pb-10 pb-12">
                ...
                <div class="md:max-w-[374px] shadow-2xl bg-[#FFFFFF] px-4 py-3 rounded-2xl mt-12">
                    <div class="flex justify-between items-start">
                        ...
                        <a target="_blank" href="<?php echo e($PagesContantManage['hero_section']['linkedin']['profile_link']); ?>"><img class="mt-0.5" src="<?php echo e(asset('front_assets/public/images/uifry-linkedin.svg')); ?>" width="25" height="25" alt="uifry-linkedin"></a>
                    </div>
    ...
    <div class="container">
        <div class="grid grid-cols-12 lg:items-end items-center lg:gap-0 md:gap-5 gap-y-12 lg:px-10 px-0">
            <div class="md:col-span-6 col-span-12 lg:max-w-[530px]">
                <h2 class="text-[#011632] lg:text-[42px] text-3xl font-semibold inline-block"><?php echo e($PagesContantManage['home_section']['email_subscribe']['title']); ?></h2>
                <p class="text-[#3C4959] text-lg lg:mt-5 mt-3"><?php echo e($PagesContantManage['home_section']['email_subscribe']['description']); ?></p>
                <div
                    class="border border-[#D0D5DD] rounded-lg flex justify-between items-center focus:outline-none lg:max-w-[440px] lg:mt-10 mt-5">
                    <span>
                        <img class="max-w-max mx-2" src="<?php echo e(asset('front_assets/public/images/uifry-call-icon.svg')); ?>" width="25" height="25" alt="uifry-call-icon">
            ...
            <div class="md:col-span-6 col-span-12 text-right">
                <img class="relative rounded-lg" src="<?php echo e(asset('uploads/' . $PagesContantManage['home_section']['email_subscribe']['image'])); ?>" width="413" height="362"
    ...
    <div class="container">
        <div class="grid grid-cols-12 lg:gap-0 md:gap-5 gap-y-12 lg:items-start items-center lg:px-10 px-0">
            ...
            <div class="md:col-span-6 col-span-12 text-right lg:pe-7">
                <img class="relative rounded-lg" src="<?php echo e(asset('uploads/' . $PagesContantManage['home_section']['smile_image'])); ?>" width="410" height="326"
                    alt="uifry-healthier">
...
<section class="patients lg:pb-[120px] pb-[70px]">
    <div class="container mx-auto lg:!max-w-[1064px] md:text-center">
        <h2
            class="lg:text-[42px] text-3xl text-[#011632] font-semibold inline-block lg:max-w-[630px] md:max-w-[500px]  max-w-[361px] mx-auto"><?php echo e($PagesContantManage['home_section']['video']['title']); ?>
        ...
        <div class="mt-12 relative">
            ...
            <iframe class="rounded-xl w-full lg:inline hidden" width="560" height="350" src="<?php echo e(old('about_patients_overview_video', isset($PagesContantManage) ? $PagesContantManage['home_section']['video']['url'] : '')); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                ...
                <div class="swiper-wrapper flex transition-transform duration-300 ">
                    ...
                    <div class="swiper-slide rounded-lg overflow-hidden relative">
                        ...
                        <div class="absolute top-0 left-0 w-full h-full p-4 flex flex-col justify-between items-end">
                            <img src="<?php echo e(asset('front_assets/public/images/uifry-linkedin-icon.webp')); ?>" width="40" height="40" alt="uifry-linkedin-icon">
        ...
        <div class="swiper-container swipe3 lg:mt-[70px] mt-8">
            <div class="swiper-wrapper transition-transform duration-300 lg:grid lg:grid-cols-12 lg:gap-5">
                ...
                <div class="swiper-slide rounded-xl bg-[#E6F6FE] px-5 pt-5 pb-2.5 lg:col-span-3 md:col-span-4">
                    <img class="rounded-xl w-full" src="<?php echo e(asset('images/'.$Blog->image)); ?>" width="265" height="230" alt="uifry-article">
                    <span class="inline-block bg-[#011632] rounded-md lg:text-base text-sm text-white px-3 py-1.5 mt-5">Self Care</span>
                    <h4 class="lg:text-lg text-base font-medium text-[#011632] lg:mt-[14px] mt-3"><?php echo e($Blog->title); ?></h4>
                    <p class="lg:text-lg text-base text-[#3C4959] lg:mt-2.5 mt-1"><?php echo e(strip_tags($Blog->description)); ?></p>
                    <span class="lg:text-base text-sm text-[#011632] block text-right lg:mt-0.5 mt-2.5"><?php echo e(strip_tags($Blog->auther)); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    ...
    <div class="container mx-auto lg:pb-[100px]">
        <div class="grid grid-cols-12 max-w-[1064px] mx-auto bg-[#011632] rounded-xl lg:px-[52px] py-12 md:gap-2.5 gap-y-10">
            <div class="md:col-span-8 col-span-12 md:pt-3">
                <h2 class="lg:text-[42px] text-3xl text-[#FFFFFF] font-semibold"><span class="lg:inline hidden"><?php echo e($PagesContantManage['home_section']['footer']['title']); ?></h2>
...
<?php echo $__env->make('frontend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\laravel-uifry\resources\views/frontend/index.blade.php ENDPATH**/ ?>