...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="brand-logo">
                <?php if(empty($settings->admin_penal_logo)): ?>
                <img src="<?php echo e(asset('admin_assets/images/logo-land.png')); ?>" alt="" style="width: 160px;height: 48px;">
                <?php else: ?>
                <img src="<?php echo e(asset('images/' . $settings->admin_penal_logo)); ?>" alt="" style="width: 160px;height: 48px;">
                <?php endif; ?> </a>
            </a>
        ...
        ***********************************--><?php /**PATH E:\xampp\htdocs\laravel-uifry\resources\views/admin/layout/header.blade.php ENDPATH**/ ?>